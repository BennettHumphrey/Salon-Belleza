...
const Instagram = () => {
  return (
    <div className="bg-bg-light pt-10 pb-16 text-text-dark px-8 flex flex-col">
      <h2 className="text-2xl font-bold text-center py-10 tracking-wider">
        {instagramData.header}
      </h2>
